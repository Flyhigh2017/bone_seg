...
Train_Image_Dir="/Users/anekisei/Documents/FCN/Train_Image/" # Images and labels for training
Train_Label_Dir="/Users/anekisei/Documents/FCN/Train_Label/"# Annotetion in png format for train images and validation images (assume the name of the images and annotation images are the same (but annotation is always png format))
UseValidationSet=False# do you want to use validation set in training
Valid_Image_Dir="/Users/anekisei/Documents/FCN/Train_Image_Dir/"# Validation images that will be used to evaluate training
Valid_Labels_Dir="/Users/anekisei/Documents/FCN/Train_Label_DIR/"#  (the  Labels are in same folder as the training set)
