...
def predict(argv=None):
    logs_dir= "/Users/anekisei/Documents/Spine_project_vertical/FCN_segment/logs/"# "path to logs directory where trained model and information will be stored"
    Image_Dir="/Users/anekisei/Documents/Spine_project_vertical/test_images"# Test image folder
    w=0.6# weight of overlay on image
    Pred_Dir="/Users/anekisei/Documents/Spine_project_vertical/FCN_segment/output/" # Library where the output prediction will be written
